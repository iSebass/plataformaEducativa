...
export default function Phase1Workspace({ onBack }) {
  ...
  // Foundational questions for Phase 1
  const quizQuestions = [
    {
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="space-y-2">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-800 dark:text-slate-100 font-display">
            Fase 1: Introducción y Definición
          </h1>
            ...
            >
              <div className="bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-6 md:p-8 space-y-6 shadow-sm dark:shadow-none">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 font-display">Clase Grabada: Definición y Generalidades</h3>
                    <p className="text-slate-500 dark:text-slate-400 text-xs sm:text-sm">Aprende con explicaciones claras sobre la base y el argumento</p>
                  </div>
                </div>
                      ...
                      return (
                        ...
                        >
                          <span className="flex items-center gap-3">
                            <span className="w-6 h-6 rounded-lg bg-slate-100 dark:bg-slate-850 flex items-center justify-center font-mono font-bold text-xs shadow-sm select-none border border-slate-200/50 dark:border-slate-800">
